...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    ...
                    <p class="pageheader-text">Events</p>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <h5 class="card-header">All Registered Events - Click Title to Edit Events</h5>
            </div>
                        ...
                        <figure class="figure">
                            ...
                            <div class="figure-img">
                                ...
                                <div class="figure-action">
                                    ...
                                    {!!Form::close()!!} --}}
                                <a href="/events/archive/{{$post->id}}" class ='btn btn-block btn-sm btn-danger' onclick="return confirm('Are you sure you want to archive this post?');" >Archive Event</a>
                                </div>
                            </div>
                            <!-- /.figure-img -->
                            <!-- .figure-caption -->
                            <figcaption class="figure-caption">
                                <h3 class="figure-title"><a href="/events/{{$post->id}}/edit">{{$post->theme}}</a></h3>
                                {{-- <p class="text-muted mb-0">CATEGORY: {{$post->category}} </p> --}}
                                <p class="text-muted mb-0">DATE: {{$post->date}} </p>
                                <p class="text-muted mb-0">LOCATION:<br/> {{$post->location}} </p>
                                <p class="text-muted mb-0">DESCRIPTION:<br/> {{$post->description}} </p>
                            </figcaption>
                            <!-- /.figure-caption -->
                        </figure>
                        <!-- /.card-figure -->
