        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    ...
                    <p class="pageheader-text">Add News Article</p>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    {{Form::textarea('summary', '', ['class' => 'form-control', 'placeholder' => 'News Summary..', 'rows' => 2])}}
                                </div>
                                <div class="form-group">
                                    <label for="inputText3" class="col-form-label">Main News Article</label>
                                    {{Form::textarea('details', '', ['class' => 'form-control', 'placeholder' => 'Full Article...', 'rows' => 5, 'id' => 'summernote'])}}
                                </div>
