...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    ...
                    <p class="pageheader-text">News</p>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <h5 class="card-header">All Registered News - Click Title to Edit News</h5>
            </div>
                        ...
                        <figure class="figure">
                            ...
                            <div class="figure-img">
                                ...
                                <div class="figure-action">
                                    ...
                                    {!!Form::close()!!} --}}
                                <a href="/news/archive/{{$post->id}}" class ='btn btn-block btn-sm btn-danger' onclick="return confirm('Are you sure you want to archive this post?');" >Archive News Article</a>
                                </div>
                            </div>
                            <!-- /.figure-img -->
                            <!-- .figure-caption -->
