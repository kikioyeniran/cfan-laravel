...
<div class="dashboard-ecommerce">
    <div class="container-fluid dashboard-content ">
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="page-header">
                    ...
                    <p class="pageheader-text">{{$cat_name}} Art Works</p>
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Home</a></li>
                                <li class="breadcrumb-item active" aria-current="page">{{$cat_name}} Art Works</li>
                            </ol>
                        </nav>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <h5 class="card-header">All Registered {{$cat_name}} Art Works - Click Name to Edit Art Work</h5>
            </div>
                        ...
                        <figure class="figure">
                            ...
                            <div class="figure-img">
                                ...
                                <div class="figure-action">
                                    ...
                                    {!!Form::close()!!} --}}
                                <a href="/artworks/archive/{{$post->aid}}" class ='btn btn-block btn-sm btn-danger' onclick="return confirm('Are you sure you want to archive this art work?');" >Archive Art Work</a>
                                </div>
                            </div>
                            <!-- /.figure-img -->
                            <!-- .figure-caption -->
