        ...
        <div class="row">
         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['action' => ['ArtWorksController@update', $post->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="inputText3" class="col-form-label">Art Category</label>
                                      {{ Form::select('category', $catOptions, $post->category_id, ['class'=>'form-control form-control-lg', 'id'=> 'category']) }}
                                </div>
                                <div class="form-group">
                                    <label for="inputText4" class="col-form-label">Artist</label>
                                    {{ Form::select('artist', $artOptions, $post->artist_id, ['class'=>'form-control form-control-lg']) }}
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="inputText3" class="col-form-label">Measurement</label>
                                    {{Form::text('measurement', $post->measurement, ['class' => 'form-control'])}}
                                </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    {{Form::textarea('description', $post->description, ['class' => 'form-control', 'placeholder' => 'Art Description...', 'rows' => 2])}}
                                </div>
