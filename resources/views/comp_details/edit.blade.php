        ...
        <div class="row">
         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['action' => ['CompDetailsController@update', $post->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    {{Form::text('phone', $post->phone_numbers, ['class' => 'form-control'])}}
                                </div>
                                <div class="form-group">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    {{Form::textarea('mission', $post->mission, ['class' => 'form-control', 'placeholder' => 'Mission Statement...', 'rows' => 5, 'id' => 'summernote'])}}
                                </div>
