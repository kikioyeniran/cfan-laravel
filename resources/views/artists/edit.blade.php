        ...
        <div class="row">
         <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {!! Form::open(['action' => ['ArtistsController@update', $post->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    {{Form::textarea('bio', $post->bio, ['class' => 'form-control', 'placeholder' => 'Art Description...', 'rows' => 2])}}
                                </div>
                                <div class="form-group">
